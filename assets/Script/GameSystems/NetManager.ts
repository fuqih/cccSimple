import { NetNode, NetConnectOptions } from "../GameUtilitys/NetWork/NetNode";
import { NetData, CallbackObject } from "../GameUtilitys/NetWork/NetInterface";
import { BaseSystem } from "../FrameworkDesign/FrameworkBase";

export class NetManager extends BaseSystem {
    init() {
    }
